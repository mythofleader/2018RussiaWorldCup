...
class Round16LastMatchDatesController {
  ...
  getAllDates(tomorrowStartDate = Helper.getTomorrowStartDate()) {
    const firstRound16Date = this.model.round16.getFirstDate();
    const lastMatches = this.model.round16.getFromStartToEndDate(firstRound16Date, tomorrowStartDate);
...
module.exports = Round16LastMatchDatesController;
