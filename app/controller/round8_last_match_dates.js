...
class Round8LastMatchDatesController {
  ...
  getAllDates(tomorrowStartDate = Helper.getTomorrowStartDate()) {
    const firstRound16Date = this.model.round8.getFirstDate();
    const lastMatches = this.model.round8.getFromStartToEndDate(firstRound16Date, tomorrowStartDate);
...
module.exports = Round8LastMatchDatesController;
