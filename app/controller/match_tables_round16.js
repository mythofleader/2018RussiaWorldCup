...
class MatchTablesRound16 {
  ...
  getAllMatches() {
    const matches = this.model.round16.getAll();
    const message = matches.length === 0
      ? this.message.notExist
      : MatchTablesRound16.createMessageIfMatchesExist(matches);
...
module.exports = MatchTablesRound16;
