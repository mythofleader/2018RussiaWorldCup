...
class MatchTablesRound4 {
  ...
  getAllMatches() {
    const matches = this.model.round4.getAll();
    const message = matches.length === 0
      ? this.message.notExist
      : MatchTablesRound4.createMessageIfMatchesExist(matches);
...
module.exports = MatchTablesRound4;
